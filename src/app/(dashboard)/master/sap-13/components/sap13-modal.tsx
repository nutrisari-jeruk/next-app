'use client';
import { TwButton, TwInput, TwKbd, TwTreeViewReverse } from '@/components/';
...
interface Sap13Modal {
  ...
  searchValue?: string;
  className?: string;
  onNodeSelect: (node: TreeNode) => any;
  onClose: () => any;
}
            ...
            >
              <DialogPanel className="relative w-1/2 transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all">
                ...
                <div className="mt-3">
                  ...
                  <div>
                    <div className="mb-2 flex items-end justify-between space-x-2" style={{marginBottom:20}}>
